...
import com.igreja.gestao_visitantes.service.ExportarService;
...
public class VisitanteController {
    ...
    public ResponseEntity<InputStreamResource> downloadExcel() throws IOException {
        byte[] excelContent = exportarService.exportarParaExcel();

        java.io.ByteArrayInputStream in = new java.io.ByteArrayInputStream(excelContent);

        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Disposition", "attachment; filename=visitantes.xlsx");
